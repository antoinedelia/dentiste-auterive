...
<html lang="fr">
  <head>
    ...
    <title>Fiches conseil - Dentiste Auterive 31190 Cabinet dentaire des Drs DELIA, SPERTE et ARAGON</title>
  </head>
  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <!-- ADD JAVASCRIPT FICHES DÉROULANTES -->
        <div class="list-group">
          <h3>Informations Pratiques</h3>

          <a id="soins" href="javascript:;" class="list-group-item arrow" onclick="show(1, this.id);">Soins dentaires</a>
          <p id="1" class="list-group-item grey notDisplayed little">
            <strong>Chirurgien-dentiste ou Odontologiste</strong>
            <br/>
          ...
          <a id="honoraires" href="javascript:;" class="list-group-item arrow" onclick="show(2, this.id);">Honoraires et remboursements</a>
          <p id="2" class="list-group-item grey notDisplayed little">
            ...
            <br/>
            Vous pouvez consulter le site : <a href="http://www.ameli.fr/accueil-de-la-ccam/index.php" target="_blank">http://www.ameli.fr/accueil-de-la-ccam/index.php</a>
            <br/>
            <br/>
            <strong>Comment fonctionnent les remboursements d’honoraires ?</strong>
            <br/>
            <br/>
            <strong>1 - Les actes « conventionnés » :</strong> il s’agit des actes figurant dans la nomenclature de la Sécurité Sociale, de type soins dentaires courants, détartrage, carie... La Sécurité Sociale vous remboursera 70 % du tarif de convention, 80% pour les bénéficiaires de l'allocation supplémentaire du Fonds spécial vieillesse (F.S.V.) ou de l'Allocation de solidarité pour les personnes âgées (A.S.P.A.) et 90% pour les affiliés au régime social d’Alsace-Lorraine. Si vous avez souscrit une assurance complémentaire (mutuelle), celle-ci viendra compléter les 30 % restants.
            <br/>
            <br/>
            <strong>2 - Les dépassements d’honoraires :</strong> certains actes (inlay, prothèse, chirurgie…) font appel à des technologies ou à des matériaux plus élaborés. S’ils font l’objet d’un complément d’honoraires, celui-ci peut être pris en charge, pour tout ou partie, par votre mutuelle santé en fonction du type de contrat que vous avez souscrit.
            <br/>
            <br/>
            <strong>3 - Les actes dits "hors nomenclature" (chirurgie parodontale, implants dentaires) :</strong> la Sécurité Sociale ne les prend pas en charge. Votre mutuelle pourra participer aux frais en fonction de votre contrat.
            <br/>
            <br/>
            <strong>4 - Le programme de prévention de l'Assurance Maladie, M'T dents.</strong> Votre enfant peut bénéficier d'un examen bucco-dentaire gratuit s'il est sur le point de fêter ses 6, 9, 12, 15 ou 18 ans. Un mois avant son anniversaire, vous recevez chez vous une invitation à consulter le chirurgien-dentiste de votre choix. Cet examen bucco-dentaire doit avoir lieu dans les six mois suivant son anniversaire ou dans le courant de l'année s'il est déjà allé chez le chirurgien-dentiste.
          </p>
        </div>

        <div class="list-group">
          <h3>Dents chez l'adulte</h3>

          <a id="plaque_dentaire" href="javascript:;" class="list-group-item arrow" onclick="show(3, this.id);">Plaque dentaire</a>
          <p id="3" class="list-group-item grey notDisplayed little">
            <strong>Comment se forme la plaque dentaire ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Pourquoi éliminer la plaque dentaire ?</strong>
            <br/>            
          ...
          <a id="detartrage" href="javascript:;" class="list-group-item arrow" onclick="show(4, this.id);">Detartrage</a>
          <p id="4" class="list-group-item grey notDisplayed little">
            <strong>Comment se forme le tartre ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Pourquoi un détartrage ?</strong>
            <br/>
          ...
          <a id="hypersensibilité" href="javascript:;" class="list-group-item arrow" onclick="show(5, this.id);">Hypersensibilité</a>
          <p id="5" class="list-group-item grey notDisplayed little">
            <strong>Quelle est son origine ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Traitement de l’hypersensibilité</strong>
            <br/>
          ...
          <a id="haleine_fraiche" href="javascript:;" class="list-group-item arrow" onclick="show(6, this.id);">Conserver une haleine fraîche</a>
          <p id="6" class="list-group-item grey notDisplayed little">
            <strong>Contrôler la mauvaise haleine</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Traitements pour une haleine fraîche</strong>
            <br/>
        ...
        <div class="list-group">
          <h3>Dents de l'enfance à l'adolescence</h3>

          <a id="premiere_visite" href="javascript:;" class="list-group-item arrow" onclick="show(7, this.id);">Première visite</a>
          <p id="7" class="list-group-item grey notDisplayed little">
            <strong>Quand la première consultation doit-elle avoir lieu ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Comment se déroule la première consultation ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les rendez-vous à ne pas manquer</strong>
            <br/>
          ...
          <a id="dents_de_lait" href="javascript:;" class="list-group-item arrow" onclick="show(8, this.id);">Pourquoi soigner les dents de lait</a>
          <p id="8" class="list-group-item grey notDisplayed little">
          ...
          <a id="caries_enfant" href="javascript:;" class="list-group-item arrow" onclick="show(9, this.id);">Les caries du jeune enfants</a>
          <p id="9" class="list-group-item grey notDisplayed little">
            <strong>La carie du biberon</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Prévenez les risques de caries grâce au fluor</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Limitez le sucre</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Montrer les bons gestes d’hygiène</strong>
            <br/>
          ...
          <a id="eviter_caries" href="javascript:;" class="list-group-item arrow" onclick="show(10, this.id);">Éviter les caries grâce au scellement des sillons</a>
          <p id="10" class="list-group-item grey notDisplayed little">
            <strong>En quoi consiste l’intervention ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Pourquoi sceller les sillons des dents des enfants ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Qui peut en profiter ?</strong>
            <br/>
          ...
          <a id="dents_cassées" href="javascript:;" class="list-group-item arrow" onclick="show(11, this.id);">Dents cassées</a>
          <p id="11" class="list-group-item grey notDisplayed little">
            <strong>Les dents de lait (jusque vers 6-7 ans)</strong>
            <br/>
            ...
            <br/>
            <strong>- Si la dent de lait s'est cassée et que vous voyez une goutte de sang au niveau du trait de fracture de la dent, prenez un rendez-vous en urgence chez votre dentiste.</strong> Dans le cas où vous ne voyez pas de goutte de sang il n'y a pas de caractère d'urgence.
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les dents permanentes (à partir de 7 ans)</strong>
            <br/>
            ...
            <br/>
            <strong>- Si la dent permanente s'est cassée et que vous voyez une goutte de sang au niveau du trait de fracture de la dent, prenez un rendez-vous en urgence chez votre dentiste.</strong>
            <br/>
        ...
        <div class="list-group">
          ...
          <a id="caries" href="javascript:;" class="list-group-item arrow" onclick="show(12, this.id);">Caries</a>
          <p id="12" class="list-group-item grey notDisplayed little">
            <strong>L’évolution de la carie</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les complications locales de la carie</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Le traitement de l’infection</strong>
            <br/>
          ...
          <a id="dévitalisation" href="javascript:;" class="list-group-item arrow" onclick="show(13, this.id);">La dévitalisation</a>
          <p id="13" class="list-group-item grey notDisplayed little">
            <strong>Pourquoi dévitaliser une dent ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Comment dévitalise-t-on une dent ?</strong>
            <br/>
            ...
            <br/>
            <strong>Étape 1 :</strong> une voie d’accès est ménagée à travers la dent pour accéder aux racines.
            <br/>
            <strong>Étape 2 :</strong> la longueur de chaque racine est déterminée avec précision. Les racines sont ensuite nettoyées et élargies à l’aide de petites limes puis sont désinfectées avec des antiseptiques.
            <br/>
            <strong>Étape 3 :</strong> les racines sont obturées de façon étanche pour éviter toute réinfection.
            <br/>
            ...
            <br/>
            <br/>
            <strong>Reconstitution de la dent après dévitalisation</strong>
            <br/>
          ...
          <a id="aphtes" href="javascript:;" class="list-group-item arrow" onclick="show(14, this.id);">Les aphtes</a>
          <p id="14" class="list-group-item grey notDisplayed little">
            <strong>Que sont les aphtes ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Quelle est leur origine ?</strong>
            <br/>
          ...
          <a id="abces" href="javascript:;" class="list-group-item arrow" onclick="show(15, this.id);">Les abcès</a>
          <p id="15" class="list-group-item grey notDisplayed little">
            <strong>Les abcès d’origine dentaire</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les abcès parodontaux</strong>
            <br/>
          ...
          <a id="bruxisme" href="javascript:;" class="list-group-item arrow" onclick="show(16, this.id);">Le bruxisme</a>
          <p id="16" class="list-group-item grey notDisplayed little">
          ...
          <a id="examen_radio_pano" href="javascript:;" class="list-group-item arrow" onclick="show(17, this.id);">L'examen radiologique panoramique</a>
          <p id="17" class="list-group-item grey notDisplayed little">
            ...
            <br/>
            - Chez l'enfant, la panoramique dentaire permet de visualiser les germes des dents définitives, c'est-à-dire des futures dents de l'adulte. Ceci autorise l'évaluation de l'âge dentaire.
            ...
            <br/>
            <br/>
            L’examen est habituellement pratiqué chez le radiologue.
            Certains cabinets dentaires disposent toutefois de l'appareillage nécessaire.
          </p>
        </div>
        ...
        <div class="list-group">
          ...
          <a id="gingivites" href="javascript:;" class="list-group-item arrow" onclick="show(18, this.id);">Les gingivites</a>
          <p id="18" class="list-group-item grey notDisplayed little">
            <strong>Qu’est-ce qu’une gingivite ?</strong>
            <br/>
          ...
          <a id="parodontites" href="javascript:;" class="list-group-item arrow" onclick="show(19, this.id);">Le traitement des parodontites</a>
          <p id="19" class="list-group-item grey notDisplayed little">
            <strong>Le traitement initial des parodontites</strong>
            <br/>
            La désinfection des tissus parodontaux repose conjointement sur : 
            <br/>
             - L'utilisation à domicile de <strong>matériel spécifique</strong> permettant de nettoyer efficacement les dents même dans les zones les plus difficiles d’accès
            <br/>
            ...
            <br/>
            <br/>
            <strong>Le traitement chirurgical des parodontites</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Maintien des résultats obtenus</strong>
            <br/>
          ...
          <a id="surfacage" href="javascript:;" class="list-group-item arrow" onclick="show(20, this.id);">Le surfaçage</a>
          <p id="20" class="list-group-item grey notDisplayed little">
            <strong>Objectif du surfaçage</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Comment réalise-t-on un surfaçage ?</strong>
            <br/>
        ...
        <div class="list-group">
          ...
          <a id="types_prothèses" href="javascript:;" class="list-group-item arrow" onclick="show(21, this.id);">Les différents types de prothèses dentaires</a>
          <p id="21" class="list-group-item grey notDisplayed little">
            <strong>L’empreinte dentaire</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les prothèses dentaires fixées aux dents</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les prothèses dentaires amovibles</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les prothèses dentaires sur implants</strong>
            <br/>
          ...
          <a id="inlays+onlays" href="javascript:;" class="list-group-item arrow" onclick="show(22, this.id);">Les inlays et les onlays</a>
          <p id="22" class="list-group-item grey notDisplayed little">
            <strong>Pourquoi un inlay/onlay plutôt qu'un simple plombage ou une résine dentaire ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Inlays, onlays et esthétique</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Technique de réalisation :</strong>
            <br/>
            <strong>Première séance : la dent est préparée</strong> en nettoyant la carie et en taillant une cavité qui accueillera :
            <br/>
            ...
            <br/>
            <strong>Deuxième séance : l'inlay est posé et collé</strong> dans la cavité de la dent. Contrairement aux obturations classiques, les inlays/onlays n’exercent pas de pressions sur les parois dentaires restantes (risque de fracture).
          ...
          <a id="pap" href="javascript:;" class="list-group-item arrow" onclick="show(23, this.id);">Prothèses amovibles partielles</a>
          <p id="23" class="list-group-item grey notDisplayed little">
            <strong>Les prothèses entièrement en résine</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les prothèses à châssis métallique (ou stellite)</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les crochets sur les dents</strong>
            <br/>
          ...
          <a id="bridges" href="javascript:;" class="list-group-item arrow" onclick="show(24, this.id);">Les bridges et ponts dentaires</a>
          <p id="24" class="list-group-item grey notDisplayed little">
            <strong>Les bridges collés</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les bridges conventionnels</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les implants dentaires remplacent progressivement les bridges</strong>
            <br/>
          ...
          <a id="pac" href="javascript:;" class="list-group-item arrow" onclick="show(25, this.id);">Les prothèses amovibles complètes</a>
          <p id="25" class="list-group-item grey notDisplayed little">
            <strong>Conception de la prothèse</strong>
            <br/>
          ...
          <a id="inlay_cores" href="javascript:;" class="list-group-item arrow" onclick="show(26, this.id);">Les inlay-cores</a>
          <p id="26" class="list-group-item grey notDisplayed little">
            ...
            <br/>
            <br/>
            <strong>Principales indications</strong>
            <br/>
        ...
        <div class="list-group">
          ...
          <a id="implant" href="javascript:;" class="list-group-item arrow" onclick="show(27, this.id);">Qu'est-ce qu'un implant dentaire ?</a>
          <p id="27" class="list-group-item grey notDisplayed little">
            <strong>Quand pose-t-on un implant ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Indications et contre-indications</strong>
            <br/>
          ...
          <a id="pose_implants" href="javascript:;" class="list-group-item arrow" onclick="show(28, this.id);">Pose d'implants dentaires</a>
          <p id="28" class="list-group-item grey notDisplayed little">
            <strong>Mise en place des implants dans une clinique ou au cabinet dentaire</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>La mise en place de l’implant</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>La fermeture du site chirurgical</strong>
            <br/>
            ...
            <br/>
            <strong>1ère option :</strong> avec enfouissement total des implants
            <br/>
            ...
            <br/>
            <strong>2ème option :</strong> sans enfouissement des implants 
            <br/>
          ...
          <a id="pré_implant" href="javascript:;" class="list-group-item arrow" onclick="show(29, this.id);">L'analyse pré-implantaire</a>
          <p id="29" class="list-group-item grey notDisplayed little">
            <strong>Réalisation d’un projet prothétique</strong>
            <br/>
            La mise en place d’implants est avant tout destinée à supporter une prothèse qui doit être esthétique et fonctionnelle. C’est donc le projet de la future prothèse qui va guider la mise en place des implants. 
            ...
            Une planification totalement informatisée peut également être utilisée dans certaines situations. 
            <br/>
            ...
            <br/>
            <br/>
            <strong>Planification de l’intervention chirurgicale</strong>
            <br/>
          ...
          <a id="douleur" href="javascript:;" class="list-group-item arrow" onclick="show(30, this.id);">Douleur et implants dentaires</a>
          <p id="30" class="list-group-item grey notDisplayed little">
            <strong>Quelles sont les suites opératoires ?</strong>
            <br/>
            Après la mise en place d’implants, diverses réactions peuvent apparaître : 
            <br/>
             - <strong>Une douleur :</strong> elle dépend principalement de l’importance de l’intervention, c’est-à-dire du nombre d’implants posés dans la séance. La douleur post-opératoire est très variable d’une personne à une autre. De façon générale, pour la mise en place de 1 ou 2 implants, la douleur est nulle ou faible. Pour des interventions plus importantes, une gêne supplémentaire est à prévoir pendant quelques jours.
            <br/>
             - <strong>Un œdème :</strong> il s’agit d’un gonflement de la gencive et de la joue lié à la réaction inflammatoire qui suit toute intervention chirurgicale. Il est souvent présent de façon très légère. Dans certains cas, il peut s’avérer plus important.
            <br/>
             - <strong>Un hématome :</strong> il est dû à un saignement interne qui persiste de façon transitoire après l’intervention et survient occasionnellement. Lorsqu’il est étendu, il peut paraître impressionnant mais il est rarement inquiétant.
            <br/>
            ...
            <br/>
            <br/>
            <strong>Gestion du stress et de la douleur</strong>
            <br/>
          ...
          <a id="maintenance" href="javascript:;" class="list-group-item arrow" onclick="show(31, this.id);">La maintenance implantaire</a>
          <p id="31" class="list-group-item grey notDisplayed little">
            <strong>Les complications implantaires</strong>
            <br/>
             - <strong>Les complications infectieuses :</strong> les implants, comme les dents, peuvent se déchausser. Le déchaussement des implants appelé péri-implantite est un phénomène infectieux causé le plus souvent par un nettoyage insuffisant autour des implants.
            <br/>
             - <strong>Les complications mécaniques :</strong> ces complications sont rares. Il s’agit de fractures des implants eux-mêmes, ou des vis qui servent à fixer la prothèse dans l’implant.
            <br/>
            <br/>
            <strong>Prévention des complications</strong>
            <br/>
          ...
          <a id="passeport" href="javascript:;" class="list-group-item arrow" onclick="show(32, this.id);">Votre passeport implantaire</a>
          <p id="32" class="list-group-item grey notDisplayed little">
            ...
            <br/>
            <br/>
            <strong>Votre passeport comprend deux volets :</strong>
            <br/>
             - <strong>Le volet "Implant Chirurgie"</strong> mentionne le nom de l'implant, le nom du fabriquant et le numéro de lot, la position de l'implant dentaire, ainsi que sa longueur, son diamètre et sa composition.
            <br/>
             - <strong>Le volet "Prothèse supra-implantaire"</strong> précise si la prothèse est fixée ou scellée, le type de ciment employé (provisoire ou définitif) et son numéro de lot, le matériau utilisé pour le pilier prothétique et la prothèse fixée, le numéro de lot...
            <br/>
            <br/>
        ...
        <div class="list-group">
          <h3>Les choix esthétiques</h3>
          
          <a id="blanchiment" href="javascript:;" class="list-group-item arrow" onclick="show(33, this.id);">Le blanchiment</a>
          <p id="33" class="list-group-item grey notDisplayed little">
            <strong>La consultation préliminaire</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les différentes techniques d'éclaircissement :</strong>
            <br/>
            - <strong>Au cabinet :</strong> 1 à 2 séances de 30 à 60 minutes sont à prévoir au fauteuil. Après avoir mis en place une protection au niveau des gencives, un gel blanchissant est appliqué sur l’émail des dents et activé par une lampe à UV.
            <br/>
            - <strong>A la maison (technique ambulatoire) :</strong> l’empreinte des deux mâchoires est effectuée au cabinet afin d’élaborer des gouttières en plastique ajustées à la dentition.
            ...
            <br/>
            - <strong>Pour les dents dévitalisées</strong> qui ont noirci au cours du temps mais qui ne sont pas trop atteintes, il existe une technique de blanchiment spécifique. Après avoir protégé l’intérieur de la racine par une sorte de bouchon, un gel blanchissant est placé dans le reste de la partie supérieure de la dent. Le produit est laissé à l’intérieur de la dent, de quelques jours à quelques semaines. Quand la dent a récupéré la même teinte que les dents voisines, le gel est retiré et la dent est rebouchée définitivement.
          </p>
          
          <a id="coloration" href="javascript:;" class="list-group-item arrow" onclick="show(34, this.id);">Les colorations dentaires</a>
          <p id="34" class="list-group-item grey notDisplayed little">
            <strong>Mes dents sont tachées, que faire ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>Je ne veux pas d’amalgame, peut-on me proposer autre chose de plus esthétique ?</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>J’ai une dent dévitalisée qui noircit. Y a-t-il une solution pour l’éclaircir ?</strong>
            <br/>
        ...
        <div class="list-group">
          <h3>Prendre soin de ses dents</h3>
          
          <a id="regles_or" href="javascript:;" class="list-group-item arrow" onclick="show(35, this.id);">Les 10 règles d'or d'une bonne hygiène dentaire</a>
          <p id="35" class="list-group-item grey notDisplayed little">
             - <strong>Idéalement deux brossages par jour sont recommandés.</strong> En pratique, deux brossages quotidiens minutieux permettent d’obtenir une hygiène satisfaisante, si la gencive est en bonne santé. En cas de maladie des gencives, les trois brossages quotidiens sont indispensables. Ne rien manger ni boire (à part de l’eau) après le brossage du soir.
            <br/>
            <br/>
             - <strong>La brosse utilisée doit être à poils souples, avec une tête de petite dimension pour accéder à tous les recoins.</strong> Des poils trop durs peuvent user votre émail de façon importante sur le long terme. Mieux vaut un brossage doux et un peu plus long qu’un brossage agressif qui risquerait d’abîmer votre émail et vos gencives.
            <br/>
            <br/>
             - <strong>La brosse manuelle permet d’obtenir d’excellents résultats lorsqu’elle est bien utilisée.</strong> Certaines brosses électriques permettent d’obtenir les mêmes résultats avec un peu plus de facilité.
            <br/>
            <br/>
             - <strong>Brossez toujours vos dents en faisant un mouvement de la gencive vers la dent.</strong> Au début du mouvement, les poils de la brosse doivent être posés sur la gencive. Attention à bien brosser toutes les faces des dents.
            <br/>
            <br/>
             - <strong>Les brossettes interdentaires et le fil dentaire font partie intégrante du brossage.</strong> En effet, la brosse à dents ne nettoie pas entre les dents. Une grande partie des problèmes dentaires (caries, déchaussements...) démarre entre les dents puisque les bactéries y stagnent. Si la gencive est en bonne santé, le passage des brossettes doit être fait une fois par jour, idéalement le soir. En cas de maladie des gencives, il peut être nécessaire de le faire 2 à 3 fois par jour. Si les espaces interdentaires sont trop étroits, les brossettes doivent être remplacées par du fil dentaire.
            <br/>
            <br/>
             - <strong>Pensez également à brosser la langue.</strong> Il existe des instruments spéciaux pour cela, mais la brosse à dents est suffisante. En effet la face externe de la langue est recouverte de bactéries qui peuvent contribuer, notamment, à une mauvaise haleine.
            <br/>
            <br/>
             - <strong>Les hydropulseurs peuvent être utilisés en complément de la brosse.</strong> Ils peuvent être utiles pour enlever des débris alimentaires et faire un massage des gencives. Cependant leur action est insuffisante pour décoller les bactéries de la plaque dentaire, et ils ne remplacent en aucune façon la brosse à dent, ni les brossettes interdentaires.
            <br/>
            <br/>
             - <strong>Le dentifrice doit être fluoré</strong> pour vous protéger des caries. A chaque âge correspond un dosage en fluor. Dans certains cas, un dentifrice spécifique peut être conseillé.
            <br/>
            <br/>
             - <strong>Les bains de bouche antiseptiques ne doivent pas être utilisés quotidiennement</strong> en dehors des cures prescrites par le dentiste.
            <br/>
            <br/>
             - <strong>Certains aliments sucrés et acides (comme les sodas ou le citron) abîment fortement les dents.</strong> Les consommer avec modération.
          </p>
          
          <a id="manuelle_electrique" href="javascript:;" class="list-group-item arrow" onclick="show(36, this.id);">Brosse à dents manuelle ou brosse à dents électrique ?</a>
          <p id="36" class="list-group-item grey notDisplayed little">
            ...
            <br/>
            <br/>
            <strong>Quel type de brosse choisir ?</strong>
            <br/>
            ...
            <br/>
            <strong>La brosse à dents manuelle :</strong>
            <br/>
            ...
            <br/>
            <br/>
            <strong>La brosse à dents électrique :</strong>
            <br/>
            ...
            <br/>
            <strong>Changer la tête de sa brosse à dents électrique tous les 3 mois</strong>
            <br/>
            <br/>
            <strong>Technique de brossage</strong>
            <br/>
             - Brosser ses dents sur de petites surfaces à la fois, avec un mouvement de rouleau
            <br/>
             - Se brosser les dents en allant des gencives vers les dents, du rose vers le blanc<br/>
            <br/>
        ...
        <div class="list-group">
          ...
          <a id="vrai_faux" href="javascript:;" class="list-group-item arrow" onclick="show(37, this.id);">Vrai ou faux ?</a>
          <p id="37" class="list-group-item grey notDisplayed little">
            <strong>Le blanchiment abîme-t-il les dents ?</strong>
            <br/>
            <strong>FAUX</strong> : Les produits de blanchiment (peroxyde de carbamide ou d’hydrogène) sont de plus en plus efficaces tout en étant inoffensifs pour les tissus dentaires. Leur innocuité a été prouvée dans de nombreuses études cliniques réalisées sur plusieurs années. 
            <br/>
            ...
            <br/>
            <br/>
            <strong>Les caries font-elles toujours mal ?</strong>
            <br/>
            <strong>FAUX</strong> : Probablement plus de la moitié des caries ne sont pas ressenties par les patients car elles ne sont pas douloureuses. D’où l’importance d’un dépistage très régulier.
            <br/>
            <br/>
            <strong>Avec l'âge, le déchaussement des dents est-il une fatalité ?</strong>
            <br/>
            <strong>FAUX</strong> : Des mesures de prévention efficaces et des traitements adaptés existent pour se prémunir de ces problèmes. Garder une bouche saine tout au long de sa vie est possible grâce à un suivi bucco-dentaire dès le plus jeune âge.
            <br/>
            <br/>
            <strong>Les infections dentaires peuvent provoquer des problèmes cardiaques !</strong>
            <br/>
            <strong>VRAI</strong> : Les microbes présents dans les infections dentaires peuvent passer dans la circulation sanguine et provoquer des problèmes cardiaques. Ceci est d’autant plus vrai chez les personnes qui présentent déjà une pathologie du cœur.
            <br/>
            <br/>
            <strong>Le tartre déchausse les dents</strong>
            <br/>
            <strong>VRAI</strong> : Le tartre est très poreux. C’est un vrai nid à microbes. S’il n’est pas retiré régulièrement, les microbes qui s’y logent peuvent provoquer une inflammation de la gencive, entraînant un déchaussement des dents.
            <br/>
            <br/>
            <strong>Pas de soins dentaires chez la femme encei</strong>nte
            <br/>
            <strong>FAUX</strong> : Des soins peuvent être prodigués pendant le deuxième trimestre de la grossesse. Au premier et au troisième trimestre, seuls les soins d'urgence seront réalisés.
            <br/>
            <br/>
            <strong>Les sodas, même sans sucre, sont mauvais pour les dents</strong>
            <br/>
            <strong>VRAI</strong> : Toutes les boissons acides (sodas, jus de fruits, jus de citron…) provoquent des déminéralisations de la surface de l'émail et diminuent ainsi la résistance des dents en face de la maladie carieuse. Leur consommation doit donc se faire avec modération.
            En cas de sensibilité forte aux caries, optez pour une paille afin que l'acidité ne se répande pas dans toute la bouche.
            <br/>
            <br/>
            <strong>Pour être plus efficace, le brossage des dents doit se faire avec une brosse à poils durs</strong>
            <br/>
            <strong>FAUX</strong> : Les brosses à poils durs usent l'émail des dents et abîment les gencives. La brosse à dents doit donc être à poils souples, ou éventuellement médium.
            <br/>
            <br/>
            <strong>Le détartrage abîme les dents</strong>
            <br/>
            <strong>FAUX</strong> : Le détartrage n’abîme pas les dents, bien au contraire il soulage les gencives. Les instruments utilisés ne rayent pas nos dents et ne les rendent pas mobiles.
            <br/>
            <br/>
            <strong>La cigarette provoque des caries</strong>
            <br/>
            <strong>VRAI</strong> : L’affaiblissement du système immunitaire augmente la concentration de bactéries cariogènes dans la salive du fumeur. Le risque de caries serait donc plus élevé chez le fumeur régulier. De plus, une baisse du flux salivaire est fréquemment observée chez le grand fumeur.
            <br/>
            <br/>
            <strong>Il faut être jeune pour pouvoir avoir des implants !</strong>
            <br/>
            <strong>FAUX</strong> : La mise en place d'implants est possible à tout âge, si les conditions de santé de la personne ne sont pas en contradiction avec la réalisation de l'acte chirurgical. Seules quelques pathologies et médicaments particuliers peuvent contre-indiquer de tels traitements.
            <br/>
            <br/>
            <strong>Les dents de lait n'ont pas de racine !</strong>
            <br/>
            <strong>FAUX</strong> : Les dents de lait ont des racines, tout comme les dents définitives. Pourtant, quand elles tombent, on ne voit jamais les racines car elles ont été résorbées par la poussée de la dent définitive qui fait son éruption juste en dessous.
            <br/>
            <br/>
            <strong>Mon enfant, n'a que des dents de lait, pas besoin d'aller chez le dentiste</strong>
            <br/>
            <strong>FAUX</strong> : Les dents de lait doivent être contrôlées et soignées au même titre que les dents définitives. L'infection d'une dent de lait peut avoir des répercussions sur la dent définitive sous-jacente. La première visite chez le dentiste doit avoir lieu aux alentours de l’âge de 4 ans.
            <br/>
            <br/>
            <strong>Une gencive qui saigne est une gencive malade</strong>
            <br/>
            <strong>VRAI</strong> : Un saignement de gencive régulier, qu'il soit spontané ou provoqué par le brossage, reflète un état inflammatoire, voire infectieux, de votre gencive, et ceci même en l'absence de douleur.
            ...
            <br/>
            <br/>
            <strong>Une dent dévitalisée ne peut pas avoir de carie</strong>
            <br/>
            <strong>FAUX</strong> : Une dent dévitalisée peut présenter une carie, exactement au même titre qu'une dent vivante. Par contre, comme le nerf de la dent a été retiré lors de la dévitalisation, la carie n'est pas douloureuse, sauf lorsque l'infection se propage au delà de la dent. On est alors au stade de l'abcès dentaire qui nécessite une prise en charge rapide.
            <br/>
            <br/>
            <strong>Il faut emmener les enfants chez le dentiste à partir de 6 ans</strong>
            <br/>
            <strong>FAUX</strong> : La première visite chez le dentiste doit se faire aux alentours de 3 - 4 ans. Les parents pensent souvent, à tort, que la première visite chez le dentiste doit se faire au moment de l'éruption des premières dents définitives, c’est-à-dire vers 6 ans.
            ...
            <br/>
            <br/>
            <strong>Le diabète augmente le déchaussement des dents</strong>
            <br/>
            <strong>VRAI</strong> : Le déchaussement des dents (ou parodontite) est aggravé et accéléré chez les patients qui présentent un diabète non équilibré.
            ...
            <br/>
            <br/>
            <strong>Certaines personnes sont allergiques aux implants</strong>
            <br/>
            <strong>FAUX</strong> : Les implants sont fabriqués en alliages de titane.
            ...
            <br/>
            <br/>
            <strong>Les biberons de lait peuvent provoquer des caries chez les enfants</strong>
            <br/>
            <strong>VRAI</strong> : Le lait fait partie des aliments cariogènes. Il favorise l'apparition des caries. Lorsque les enfants s'endorment avec un biberon, la stagnation d’une petite quantité de lait toute la nuit dans la bouche entraîne un fort risque d'apparition de caries.
            Si l'enfant consomme un biberon de lait avant le coucher il doit se brosser les dents juste après.
            <br/>
            <br/>
            <strong>Une gencive qui saigne est une gencive malade ?</strong>
            <br/>
            <strong>VRAI</strong> : Un saignement des gencives au brossage est le signe d'une gingivite, ou plus grave, d'une parodontite (déchaussement des dents). Le saignement est dû à une inflammation gingivale provoquée le plus souvent par la présence de bactéries et de tartre sous la gencive.
            Un traitement approprié doit alors être mis en place afin de contrôler cette situation.
            <br/>
            <br/>
            <strong>Les adultes peuvent bénéficier de traitements orthodontiques comme les enfants et les adolescents</strong>
            <br/>
            <strong>VRAI</strong> : Les déplacements et alignements dentaires peuvent être réalisés à tout âge, à condition que la bouche ait été débarrassée au préalable de tous foyers infectieux (carie, abcès, gingivite, ...).
            Chez les adultes on a recours, lorsque cela est possible, à des techniques de traitement invisibles.
            <br/>
            <br/>
            <strong>Un implant dure toute une vie</strong>
            <br/>
            <strong>FAUX</strong> : un implant peut durer de nombreuses années voire parfois toute une vie. Néanmoins, diverses complications peuvent survenir au niveau d'un implant : déchaussement, infection, fracture d'une vis ou de l'implant, ...
    ...
    <script type="text/javascript">
      function show(num, id){
        if (document.getElementById(num).style.display == "block") {
          document.getElementById(id).style.backgroundImage = "url('img/down.png')";
          document.getElementById(num).style.display = "none";
        }
        else{
          document.getElementById(id).style.backgroundImage = "url('img/up.png')";
