...
<html lang="fr">
  <head>
    ...
    <title>Contact - Dentiste Auterive 31190 Cabinet dentaire des Drs DELIA, SPERTE et ARAGON</title>
  </head>
  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <h2 class="featurette-heading">Plan d'accès</h2>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          ...
          <p class="text">Téléphone : 05 61 50 89 12</p>
